...
¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬
Footnote (Reference)
1Davide Anguita, Alessandro Ghio, Luca Oneto, Xavier Parra and Jorge L. Reyes-Ortiz. A Public Domain Dataset for Human Activity   
...
Extracted
File Name	   Variable	    atatype	Size Precision	Scale	Units	Notes
